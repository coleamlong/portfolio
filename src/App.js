...
const App = () => {
  return (
    <Container className="w-100">
      ...
      <h1 id="projects" className="text-center m-3 p-3">
        Projects
      </h1>
      <Container className="d-flex flex-column gap-4">
        {ProjectInfo.map((project) => {
          return (
            <Project
              key={project.id}
              flipped={project.id % 2 === 1}
              project={project}
            />
          );
        })}
      </Container>
      <h1 id="skills" className="text-center m-3 p-3">
        Skills
      </h1>
      <Container>
      ...
      <h1 id="contact" className="text-center m-3 p-3">
        Get in Touch
      </h1>
      <Contact />
    </Container>
